...
/*αποθηκεύονται πληροφορίες σε σχέση με το  hash bucket*/
typedef struct {
    int first;
    int last;
} HT_table;
...
/*αποθηκεύονται πληροφορίες σε σχέση με το block*/
typedef struct {
    int recordsCounter;             /*αριθμός των εγγραφών στο συγκεκριμένο block*/
    int* nextBlock;                  /*δείκτης στο επόμενο block δεδομένων */
